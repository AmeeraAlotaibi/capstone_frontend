...
class TrainerProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder(
            future:
                context.watch<TrainerProvider>().getTrainerProfile(trainerId),
                          ...
                          Column(
                            children: [
                              ...
                              DetailsContainer(
                                title1: "Experience",
                                subtitle1:
                                    '${trainer.trainerDetail.experience} YRS',
                                title2: "Age",
                                  ...
                                  ? Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            trainer.trainerDetail.subscription
                                                    ?.description ??
                              ...
                              ? Center(
                                  child: CustomButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      context.read<PlanProvider>().getPlanByID(
                                              trainer.trainerDetail
                                                  .subscription!.id!)
                                          ? context.read<PlanProvider>().renew(
                                              trainer.trainerDetail
                                                  .subscription!.id!,
                                              trainer.trainerDetail
                                                  .subscription!.duration!)
                                          : context.read<PlanProvider>().subscribe(
                                              trainer.trainerDetail
                                                  .subscription!.id!,
                                              trainer.trainerDetail
                                                  .subscription!.duration!);
